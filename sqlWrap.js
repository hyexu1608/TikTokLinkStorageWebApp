/*4.On the server side, when the app starts up, open the database. Here is some example code for this. If the database does not exist, the example creates a new empty database. It has columns for the content manager's userid, the video URL, the video nickname, and a Boolean field, called the Flag, which is "TRUE" for the most-recently-added video and "FALSE" otherwise.*/
